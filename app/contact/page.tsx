      ...
      <main>
        <section className="relative py-20 bg-muted/30">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-balance" data-aos="fade-up">
              Get in Touch
            </h1>
            <p className="text-xl text-white/90 text-pretty" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8" data-aos="fade-right">
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-6 text-balance">Contact Information</h2>
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="300">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">For reservations and inquiries</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="400">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">info@sunsetviewpoint.com</p>
                    ...
                    <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="500">
                      ...
                      <div>
                        ...
                        <div className="text-muted-foreground space-y-1">
                          ...
                          <p className="text-xs text-primary font-medium mt-2">Best sunset views: 6:00 PM - 7:30 PM</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-0">
                    <div className="w-full h-64 bg-muted rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Sunset Hill Road, Mumbai</p>
                        <Button variant="outline" className="mt-2 bg-transparent" asChild>
                          <a
                            href="https://maps.google.com/?q=Sunset+Hill+Road+Mumbai+Maharashtra"
                            target="_blank"
