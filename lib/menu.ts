...
export function getOrderLines(selectedItems: SelectedMenuItems): OrderLine[] {
...
export function getOrderSubtotal(selectedItems: SelectedMenuItems) {
  return getOrderLines(selectedItems).reduce((total, line) => total + line.lineTotal, 0);
}
