...
export function BookingForm({ selectedItems, onClearOrder }: BookingFormProps) {
  ...
  const orderLines = useMemo(() => getOrderLines(selectedItems), [selectedItems]);
  const subtotal = useMemo(() => getOrderSubtotal(selectedItems), [selectedItems]);
